...
exports.getMembersServcie = async function(req, res) {
  try {
    //connect db
    ...
    queryData.then(function(value) {
      ...
      if(req.body.hasOwnProperty("pagingToken")){
        url = ROOT_URL + req.body.groupId + "/members?limit=1000&access_token=" + token+ "&pretty=1&after=" + req.body.pagingToken;
      } else{
        url = ROOT_URL + req.body.groupId + "/members?limit=1000&access_token=" + token;
      }
      axios
      .get(url)
